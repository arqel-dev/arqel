...
`composer require arqel-dev/framework` arrastra el stack completo vía el meta-paquete: core, auth, fields, form, actions, nav, table, widgets + `inertiajs/inertia-laravel`.
