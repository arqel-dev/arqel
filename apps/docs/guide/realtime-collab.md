...
- `arqel-dev/realtime` installed and booted — it is a separate install (`composer require arqel-dev/realtime`), not bundled by the `arqel-dev/framework` meta-package.
