...
export function KeyValueInput({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: props.asObject is intentionally excluded — switching the output shape should NOT re-hydrate from value (handled by the dedicated effect below).
  useEffect(() => {
    const externalShape = (() => {
      if (Array.isArray(value)) {
