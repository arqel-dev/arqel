...
O Arqel existe para tornar admin panels Laravel + React tão produtivos quanto Filament e Nova, mas com uma stack moderna (React 19.2, Inertia 3, TypeScript strict, Radix UI). Cada contribuição:
