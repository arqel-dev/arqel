...
**Objetivo declarado** (ver `07-roadmap-fases.md` §3): entregar um framework Laravel funcional que permita instalar via `composer require arqel/arqel`, declarar Resources em PHP, e obter CRUD completo renderizado em React+ShadCN via Inertia — com 20 field types, tabela funcional, formulários, ações básicas e autorização via Laravel Policies.
...
- Criar repositório `github.com/arqel/arqel` (a organização GitHub `arqel` precisa já estar criada — confirmado livre na verificação de naming).
...
- [ ] Repositório `github.com/arqel/arqel` existe e é público
...
- Usar GitHub CLI: `gh repo create arqel/arqel --public --description "Admin panels for Laravel, forged in PHP, rendered in React."`
...
### [CORE-001] Esqueleto do pacote `arqel/core` com composer.json e PSR-4
...
- Convenção: PHP namespace espelha o nome do pacote. `arqel/core` → `Arqel\Core\`.
...
- Não usar `$loadMigrationsFrom` em CORE — migrations específicas ficam nos pacotes que as precisam (ex: `arqel/audit`).
...
## Purpose
The `arqel/core` package is the foundation of the Arqel admin panel framework. It provides:
...
- Estrutura `packages/fields/`:
  - `composer.json` (dep: `arqel/core: self.version`)
...
- [ ] `composer require arqel/fields` (path) resolve sem erros
...
- Decisão de design: separar `arqel/fields` de `arqel/core` permite:
...
### [TABLE-001] Esqueleto do pacote `arqel/table`
...
- `Table::actions([...])` aceita array de Actions (do `arqel/actions`)
...
### [FORM-001] Esqueleto do pacote `arqel/form`
...
- `composer.json` (deps: `arqel/core`, `arqel/fields`)
...
### [ACTIONS-001] Esqueleto do pacote `arqel/actions`
...
- `composer.json` (deps: `arqel/core`, `arqel/fields` para form modals, `arqel/form`)
- `src/Action.php` (base)
...
### [AUTH-001] Esqueleto do pacote `arqel/auth`
...
### [TYPES-001] Esqueleto do pacote `@arqel/types`
...
- [ ] Import funciona: `import type { FieldSchema } from '@arqel/types'`
- [ ] Subpath imports funcionam: `import type { FieldSchema } from '@arqel/types/fields'`
...
### [TYPES-004] Testes e SKILL.md do `@arqel/types`
...
### [REACT-001] Esqueleto do pacote `@arqel/react`
...
- [ ] User `import { createArqelApp } from '@arqel/react'; createArqelApp()` funciona
...
### [HOOKS-001] Esqueleto do pacote `@arqel/hooks`
...
### [HOOKS-006] Testes + SKILL.md do `@arqel/hooks`
...
### [UI-001] Esqueleto do pacote `@arqel/ui`
...
- `package.json` com peer deps @arqel/react, @arqel/hooks, @arqel/types, React 19.2+
- Deps runtime:
...
### [UI-007] Testes + SKILL.md do `@arqel/ui`
...
### [FIELDS-JS-001] Esqueleto do pacote `@arqel/fields` (JS)
...
### [FIELDS-JS-006] Testes + SKILL.md do `@arqel/fields`
...
3. Install Arqel: `composer require arqel/arqel` + `php artisan arqel:install`
4. Install frontend: `pnpm add @arqel/react @arqel/ui @arqel/hooks @arqel/fields @arqel/types`
