...
Traduz arrays de regras Laravel para schema Zod. 21 translators built-in.
...
- Catálogo: [`/pt-BR/guide/fields`](/pt-BR/guide/fields)
- Próximo: [`arqel-dev/table`](/pt-BR/reference/php/table)
