...
O `composer require arqel-dev/framework` puxa o stack completo via meta-package: core, auth, fields, form, actions, nav, table, widgets + `inertiajs/inertia-laravel`.
